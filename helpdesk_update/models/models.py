    ...
    def crearYValidarSolicitudDeTonerTest(self):
        for record in self:
            ...
            if record.team_id.id == 8 or record.team_id.id == 13:
                ...
                _logger.info("aaaa: " + str(record.x_studio_id_ticket)str(record.x_studio_id_ticket))
                if corte == 'False':
                    query = """insert into sale_order 
                                ...
                                values (""" + record.partner_id.id + """
                                        ...
                                        , """ + """t""" + """
                                        , """ + record.user_id.id + """
                                        , """ + record.x_studio_tcnico.id + """
                                        , """ + self.localidadContacto.id + """
                                        , """ + self.x_studio_empresas_relacionadas.id + """
                                        , """ + x + """
                                        , """ + 1 + """
