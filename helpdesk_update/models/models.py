...
class helpdesk_update(models.Model):
    ...
    productosSolicitud = fields.Many2many('product.product', string="Productos Solicitados",domain=lambda self: self._productos_solicitud_filtro())
    ...
    def crear_solicitud_refaccion(self):
        for record in self:
            ...
            if record.stage_id.id == 13 and record.ticket_type_id.id == 4 and record.x_studio_tipo_de_falla == 'Solicitud de refacción':
                _logger.info("entro: ****************************")
