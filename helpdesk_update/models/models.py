    ...
    def actualiza_datos_cliente(self):        
        ...
        if len(self.x_studio_equipo_por_nmero_de_serie_1) > 0 and self.team_id.id == 8:
            if len(self.x_studio_equipo_por_nmero_de_serie_1) > 1:
                ...
                raise exceptions.ValidationError("tamaño "+str(len(self.x_studio_equipo_por_nmero_de_serie_1))+'serie'+(self.x_studio_equipo_por_nmero_de_serie_1[len(self.x_studio_equipo_por_nmero_de_serie_1)-1].name))
