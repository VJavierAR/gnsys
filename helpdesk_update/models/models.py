...
class helpdesk_update(models.Model):
    ...
    seriesLastoner = fields.One2many('stock.production.lot','x_studio_id_ticket',string='Toner a solicitar',store=True,track_visibility='onchange')
    ...
    def crear_solicitud_refaccion(self):
        _logger.info("***********entrando a crear_solicitud_refaccion()")
        self.ensure_one()
