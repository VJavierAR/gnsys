...
class helpdesk_update(models.Model):
    ...
    def actualiza_datos_estado(self):
        _logger.info("staged()  **********************************#*"+str(self.uid.name))
        self.env['x_historial_helpdesk'].create({'x_id_ticket':self.x_studio_id_ticket ,'x_persona': self.uid.name,'x_estado': self.stage_id.name})        
