        ...
        for record in self:
            if record.serie:
                ...
                if(len(record.serie.x_studio_move_line)>0):
                    ...
                    localidad=moveli[0].serie.x_studio_move_line[0].sorted(key='id').location_dest_id.x_studio_field_JoD2k.x_studio_field_E0H1Z.id if(len(record.serie.x_studio_move_line)>1) else record.serie.x_studio_move_line.location_dest_id.x_studio_field_JoD2k.x_studio_field_E0H1Z.id
