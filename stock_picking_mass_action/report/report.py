...
class PartnerXlsx(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, partners):
        ...
        for obj in partners:
            ...
            i=i+1
        sheet.add_table('A2:H'+str((i+1)),{'style': 'Table Style Light 11','columns': [{'header': 'Categoria'},{'header': 'Fecha'},{'header':'Almacen'},{'header': 'Tipo'},{'header': 'Modelo'},{'header': 'No Parte'},{'header': 'Cantidad'},{'header': 'Cliente'}]})
        workbook.close()