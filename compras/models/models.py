            ...
            if(self.partner_id):
                ...
                if(mimetype=='image/svg+xml'):
                    ...
                    for c in con:
                        ...
                        product={'product_uom':1,'date_planned':self.date_order,'product_qty':cantidad,'price_unit':precio,'taxes_id':[10],'name':productid.description if(productid.description) else '/'}
                        if(noparte!=None):
