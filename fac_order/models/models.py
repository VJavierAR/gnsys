                  ...
                  for rs in range(lenset-1):
                      ...
                      for d in self.order_line:
                          ...
                          if asts[rs]==d.x_studio_servicio:  
                             self.env['sale.order.line'].create({'order_id': fac.id,'x_studio_field_9nQhR':d.x_studio_field_9nQhR.id,'product_id':d.product_id.id,'product_uom_qty':d.product_uom_qty,'price_unit':d.price_unit,'x_studio_bolsa':d.x_studio_bolsa})
