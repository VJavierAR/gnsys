...
class contratos(models.Model):
    ...
    cuentaBancaria  = fields.Selection([('24','BAJIO - 123456789 - MON NAC') ,('19','BANAMEX - 00 8754568985456542 - MONEDA NAC') ,('12','BANAMEX - 000285454558787964 - CHEQUES M.') ,('16','CI BANCO - 0001234566 - MONEDA NAC') ,('17','MULTIVA - 00041234565 - MONEDA NAC')], string = "Cuenta bancaria definida",track_visibility='onchange')
    ...
    @api.onchange('fechaDeInicioDeContrato')
    @api.depends('vigenciaDelContrato')
    def update_fecha_final_contrato(self):
        
        for contrato in self :
            if contrato.fechaDeInicioDeContrato and contrato.vigenciaDelContrato:
