...
class dcas(models.Model):
    ...
    def table(self):
        if self.serie:
            ...
            ultimosContadores='<tr><td> Último Contador </td> <td>'+str(self.contadorAnteriorNegro=n.contadorMono )+' '+str(self.fechaN)+'</br>'+'</td> <td>'+str(self.contadorAnteriorCian)+' '+str(self.fechaC)+' </br> </td> <td>'+ str(self.contadorAnteriorAmarillo)+' '+str(self.fechaA)+'</br> </td> <td>'+str(self.contadorAnteriorMagenta)+' '+str(self.fechaM)+'</br> </td> </tr>'
