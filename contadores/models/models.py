...
class dcas(models.Model):
    ...
    nivelNA=fields.Integer(string='Nivel de toner negro anteior',readonly=True)
    nivelAA=fields.Integer(string='Nivel de toner Amarillo anteior',readonly=True)
    nivelCA=fields.Integer(string='Nivel de toner Cian anteior',readonly=True)
    nivelMA=fields.Integer(string='Nivel de toner Magenta anteior',readonly=True)
    contadorAnteriorCian=fields.Integer(string='contador de ultima solicitud Cian',readonly=True)
    contadorAnteriorAmarillo=fields.Integer(string='contador de ultima solicitud Amarillo',readonly=True)
    contadorAnteriorMagenta=fields.Integer(string='contador de ultima solicitud Magenta',readonly=True)
    contadorAnteriorNegro=fields.Integer(string='contador de ultima solicitud Negro',readonly=True)
    contadorAnteriorColor=fields.Integer(string='contador de ultima solicitud Color',readonly=True)
    paginasProcesadasBN=fields.Integer(string='Páginas procesadas BN',readonly=True)
    paginasProcesadasC=fields.Integer(string='Páginas procesadas Cian',readonly=True)
    paginasProcesadasA=fields.Integer(string='Páginas procesadas Amarillo',readonly=True)
    paginasProcesadasM=fields.Integer(string='Páginas procesadas Magenta',readonly=True)
    x_studio_fecha = fields.Datetime(string='Fecha',default=lambda self: fields.datetime.now())
    renC=fields.Float(string='Rendimiento Cian',readonly=True)
    renA=fields.Float(string='Rendimiento Amarillo',readonly=True)
    renM=fields.Float(string='Rendimiento Magenta',readonly=True)
    renN=fields.Float(string='Rendimiento Negro ',readonly=True)
    ...
    tN=fields.Char(string='Ticket BN',readonly=True)
    tA=fields.Char(string='Ticket Amarillo',readonly=True)
    tC=fields.Char(string='Ticket Cian',readonly=True)
    tM=fields.Char(string='Ticket Magenta',readonly=True)
