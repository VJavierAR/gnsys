...
class gastos_gnsys(models.Model):
    ...
    quienesAutorizan = fields.One2many('res.users', 'gastoAutoriza', string = "Responsable de autorizaci髇",track_visibility='onchange')
    ...
    formaDepagoAnticipo         = fields.Selection((('Efectivo','Efectivo'), ('Cheque','Cheque'),('Deposito','Dep髎ito'),('Transferencia','Transferencia')), string = "Forma de pago",track_visibility='onchange')
    ...
    fechaLimiteDeComprobacion   = fields.Datetime(string = 'Fecha l韒ite de comprobaci髇',track_visibility='onchange')
    ...
    quienValida                 = fields.Char(string = "Responsable de aprobaci髇", track_visibility='onchange')

    motivos                     = fields.One2many('motivos', 'gasto', string = "Motivos",track_visibility='onchange')
    
    #-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    #Comprobo correctamentes
    comproboCorrectamente       = fields.Selection((('Exacto','Exacto'),('Parcial','Parcial'),('Excedido','Excedido')), string = "Tipo de comprobaci贸n",track_visibility='onchange')
    requiereDevolucion          = fields.Selection((('Efectivo','Efectivo'), ('Descuento n贸mina','Descuento n贸mina')), string = "Forma de pago",track_visibility='onchange')
    #Excacto
    ...
    fechaLimDevEfecParcial      = fields.Datetime(string = 'Fecha l铆mite devoluci贸n',track_visibility='onchange')
        #Parcial Nomina
    ...
    #La empresa cubre lo adicional 驴La empresa cubre adicional? 驴Cu谩nto?
    #Forma en que caso de que la empresa cubra lo adicional
    formaDepagoExtendida    = fields.Selection((('Efectivo','Efectivo'), ('Cheque','Cheque'),('Dep贸sito','Dep贸sito'),('Transferencia','Transferencia')), string = "Forma de pago",track_visibility='onchange')

    fechaLimiteDePago       = fields.Datetime(string = 'Fecha l铆mite de pago',track_visibility='onchange')
    ...
    formaDeCobroAdicional   = fields.Selection((('Efectivo','Efectivo'), ('Descuento n贸mina','Descuento n贸mina')), string = "Forma de pago",track_visibility='onchange')
    #Si es por efectivo
    ...
    fechaLimiteDeReceptor   = fields.Datetime(string = 'Fecha l铆mite devoluci贸n',track_visibility='onchange')
    #Si es por descuento por n贸mina 
    comoAplicaContablementeReceptorCubreAdicional = fields.Selection((('Opcion','Opcion'),('Opcion','Opcion'),('Opcion','Opcion')), string = "Como aplica contablemente",track_visibility='onchange')
     #-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    #************************************************************
    tipoDevolucionSinComprobacion               = fields.Selection((('Efectivo','Efectivo'), ('Descuento n贸mina','Descuento n贸mina')), string = "Forma de pago",track_visibility='onchange')
    ...
    fechaLimiteDevEfectivo                      = fields.Datetime(string = 'Fecha l铆mite devoluci贸n',track_visibility='onchange')
    ...
    tipoDeComprobacion = fields.Selection([('Exacto','Exacto'), ('Parcial','Parcial'), ('Excedido','Excedido'), ('noComprobado','No se comprobo correctamente')], string = "Tipo de comprobaci贸n", track_visibility='onchange')
