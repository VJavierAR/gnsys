...
class gastos_gnsys(models.Model):
    ...
    statusGasto = fields.Selection([('enSolicitud','En solicitud'), ('autorizacion','En autorización'), ('aprovacion','En aprovación'), ('cancelado','Cancelado')], string = "Status de gasto")
    @api.one
