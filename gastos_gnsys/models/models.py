...
class gastos_gnsys(models.Model):
    ...
    statusGasto = fields.Selection([('enSolicitud','En solicitud'), ('autorizacion','En autorización'), ('aprovacion','En aprovación'), ('cancelado','Cancelado')], required = True, default='enSolicitud')
    @api.multi
