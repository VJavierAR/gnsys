...
class gastos_gnsys(models.Model):
    ...
    quienValida                 = fields.Many2one('res.users',string = "Responsable de aprobacion", track_visibility='onchange')
...
class motivos_gastos(models.Model):
    ...
    motivoDescripcion = fields.Text(string = "Descripción de motivo",track_visibility='onchange')
